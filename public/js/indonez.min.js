...
function() {
    const e = location.pathname.slice(location.pathname.lastIndexOf("index.html") + 1)
...
function() {
    ...
    if (t.length > 0 && "blog-article.html" != location.pathname.slice(location.pathname.lastIndexOf("index.html") + 1)) {
        const n = document.querySelectorAll(".uk-navbar-nav li")[0].getElementsByTagName("a")[0].pathname;
        t[0].innerHTML = `<li><a href="${n.slice(location.pathname.lastIndexOf("/") + 1)}">Home</a></li>`,
...
if (null !== mainNav) {
    ...
    Array.from(e.children).forEach((function(e) {
        2 == e.children.length && (e.classList.add("uk-parent"),
    ...
    t.forEach((function(e) {
        ...
        n(e.parentElement),
        null !== e.querySelector("a.uk-disabled") && (n(e.parentElement.parentElement),
        n(e.parentElement),
...
function counterUp(e) {
    ...
    this.props = {},
    this.defaults)
        void 0 !== n && (t.props[n] = t.defaults[n],
...
function iframeVid(e) {
    ...
    this.props = {},
    this.defaults)
        void 0 !== t && (this.props[t] = this.defaults[t],
        e.hasOwnProperty(t) && this.props.hasOwnProperty(t) && (this.props[t] = e[t]));
...
!function() {
    ...
    window.addEventListener("scroll", (function() {
        setTimeout((function() {
            window.scrollY > 300 ? (e.style.opacity = 1,
            e.classList.add("uk-animation-slide-top")) : (e.style.opacity -= .1,
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    void 0 !== t && null != t && t.addEventListener("click", t=>{
        t.preventDefault();
        ajaxRequest("POST", "#", serialize(document.getElementById("contact-form")), (t,n)=>{
            if (t) {
                ...
                e.reset()) : (t.nameError && document.getElementById("name").classList.add("uk-form-danger"),
                document.getElementById("name").addEventListener("click", (function() {
                    document.getElementById("name").classList.remove("uk-form-danger")
                }
                )),
                t.emailError && document.getElementById("email").classList.add("uk-form-danger"),
                document.getElementById("email").addEventListener("click", (function() {
                    document.getElementById("email").classList.remove("uk-form-danger")
                }
                )),
                t.subjectError && document.getElementById("subject").classList.add("uk-form-danger"),
                ...
                t.messageError && document.getElementById("message").classList.add("uk-form-danger"),
...
counterUp.prototype.update = function() {
    ...
    this.elems.forEach((function(t) {
        t.val += t.step,
        t.val < t.end ? (1 == t.intvalues ? t.obj.innerHTML = t.prepend + Math.floor(t.val).toString() + t.append : t.obj.innerHTML = t.prepend + (Math.round(100 * t.val) / 100).toString() + t.append,
