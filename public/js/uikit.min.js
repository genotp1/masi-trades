...
!function(t, e) {
    ...
    var e = {}
      , n = /([a-z\d])([A-Z])/g;
    function d(t) {
        return t in e || (e[t] = t.replace(n, "$1-$2").toLowerCase()),
        e[t]
    }
    var r = /-(\w)/g;
    function f(t) {
    ...
    function V(t) {
        return A(t) ? [t] : N(t) ? m.slice.call(t) : k(t) ? t.map(W).filter(Boolean) : C(t) ? t.toArray() : []
    }
    function R(t) {
    ...
    var rt = {
        ratio: function(t, e, i) {
            var n = "width" === e ? "height" : "width"
              , r = {};
            return r[n] = t[e] ? Math.round(i * t[n] / t[e]) : t[n],
            r[e] = i,
            r
        },
    ...
    function Bt(t, e) {
        ...
        M(t) ? Dt.call(t, e) : V(t).map(function(t) {
            return Bt(t, e)
        }).filter(Boolean)
    }
    function Pt(t) {
    ...
    function Xt() {
        for (var t = [], e = arguments.length; e--; )
            t[e] = arguments[e];
        var i, n, r = Qt(t), o = r[0], s = r[1], a = r[2], h = r[3], u = r[4], o = ne(o);
        return 1 < h.length && (i = h,
        h = function(t) {
    ...
    function Zt(t, e, i, n) {
        ...
        return void 0 === e && (e = !0),
        void 0 === i && (i = !1),
        D(t) && ((r = document.createEvent("CustomEvent")).initCustomEvent(t, e, i, n),
        t = r),
        t
    }
    function Qt(t) {
    ...
    function de(s, a) {
        return new ae(function(t, e) {
            ...
            for (var o in n.open(i.method.toUpperCase(), s),
            i.headers)
    ...
    function ge(t, e, i, n) {
        ...
        void 0 === n && (n = !1);
        var r = (e = V(e)).length;
        return t = P(t) ? F(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : me(e, t),
        n ? tt(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    function ve(t) {
        return (t = Me(t)).innerHTML = "",
        t
    }
    function we(t, e) {
        return t = Me(t),
    ...
    function Te(t) {
        V(t).map(Pt).filter(function(t, e, i) {
    ...
    function Ce(t) {
        ...
        return Ee.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : i.textContent = t,
    ...
    function Le(t) {
        for (var n, r = [], e = arguments.length - 1; 0 < e--; )
            r[e] = arguments[e + 1];
        r.length && (n = D(K(r = je(r))) ? [] : r.pop(),
        r = r.filter(Boolean),
        V(t).forEach(function(t) {
            for (var e = t.classList, i = 0; i < r.length; i++)
                We.Force ? e.toggle.apply(e, [r[i]].concat(n)) : e[(H(n) ? !e.contains(r[i]) : n) ? "add" : "remove"](r[i])
        }))
    }
    function Fe(t, i, n) {
        (i = je(i).filter(Boolean)).length && V(t).forEach(function(t) {
            var e = t.classList;
            We.Multiple ? e[n].apply(e, i) : i.forEach(function(t) {
                return e[n](t)
            })
        })
    }
    ...
    function Xe(t) {
        ...
        return ct ? (t in Ye || (De(e = be(i, document.createElement("div")), "uk-" + t),
        Ye[t] = Ue(e, "content", ":before").replace(/^["'](.*)["']$/, "$1"),
        $e(e)),
        Ye[t]) : qe(i).getPropertyValue("--uk-" + t)
    }
    var Ge = {};
    function Ke(t) {
    ...
    function ei(t, e, s, a, h) {
        ...
        ae.all(V(t).map(function(o) {
            return new ae(function(i, n) {
                ...
                w(e, ti) && De(o, a && "uk-transform-origin-" + a, h && ti + "reverse")
            }
            )
        }))
    }
    ...
    function si(i, n) {
        ...
        ["left", "top"].forEach(function(t) {
            var e;
            t in n && (e = Re(i, t),
            Re(i, t, n[t] - r[t] + j("absolute" === o && "auto" === e ? hi(i)[t] : e)))
        })
    }
    function ai(t) {
        if (!t)
            return {};
        var e, i, n = R(t), r = n.pageYOffset, o = n.pageXOffset;
        if (E(t)) {
            var s = t.innerHeight
              , a = t.innerWidth;
            return {
    ...
    function di(n) {
        ...
        return function(t, e) {
            if (H(e)) {
                ...
                return (e = "auto" === (e = Re(t = W(t), n)) ? t["offset" + r] : j(e) || 0) - fi(t, n)
            }
    ...
    function fi(i, t, e) {
        ...
        Re(i, "boxSizing") === e ? ri[t].slice(1).map(p).reduce(function(t, e) {
            return t + j(Re(i, "padding" + e)) + j(Re(i, "border" + e + "Width"))
        }, 0) : 0
    }
    function pi(o, s, a, h) {
        J(ri, function(t, e) {
    ...
    function wi(t, e, i) {
        ...
        void 0 === i && (i = window),
        P(t) ? +t : u(t, "vh") ? bi(ci(R(i)), t) : u(t, "vw") ? bi(li(R(i)), t) : u(t, "%") ? bi(ai(i)[e], t) : j(t)
    }
    function bi(t, e) {
        return t * j(e) / 100
    }
    ...
    function Mi(t, e) {
        ...
        void 0 === e && (e = []);
        try {
            return t ? w(t, "{") ? JSON.parse(t) : e.length && !b(t, ":") ? ((i = {})[e[0]] = t,
            i) : t.split(";").reduce(function(t, e) {
                var i = e.split(/:(.*)/)
                  , n = i[0]
                  , r = i[1];
                return n && !H(r) && (t[n.trim()] = r.trim()),
                t
            }, {}) : {}
        } catch (t) {
            return {}
    ...
    Ei.data = function(e, i, t) {
        return t ? _i(e, i, t) : i ? e ? function(t) {
            return _i(e, i, t)
        }
        : i : e
    }
            ...
            for (var l = ji(t).concat(t), i = ae.resolve(), n = function(u) {
                i = i.then(function() {
                    return new ae(function(i) {
                        var t, n = l[u], e = l[u + 1], r = n.scrollTop, o = Math.ceil(hi(e, Fi(n)).top - c), s = (t = Math.abs(o),
                        40 * Math.pow(t, .375)), a = Date.now(), h = function() {
                            var t, e = (t = tt((Date.now() - a) / s),
                            .5 * (1 - Math.cos(Math.PI * t)));
                            Pi(n, r + o * e),
                            1 != e ? requestAnimationFrame(h) : i()
                        };
                        h()
                    }
                    )
    ...
    function Li(t, e) {
        ...
        var i = Wi(t)
          , n = Ut(t).filter(function(t) {
            return t === i || e.test(Re(t, "overflow")) && t.scrollHeight > Math.round(si(t).height)
        }).reverse();
        return n.length ? n : [i]
    }
    function Fi(t) {
    ...
    Ni.prototype.enableApi = function() {
        ...
        return r || o ? this.ready = new ae(function(t) {
            ...
            ,
            new ae(function(i) {
                return Kt(window, "message", function(t, e) {
                    return i(e)
                }, !1, function(t) {
                    var e = t.data;
                    if (e && D(e)) {
    ...
    var Vi = ut && window.IntersectionObserver || function() {
        function t(e, t) {
            ...
            void 0 === n && (n = "0 0"),
            this.targets = [];
            var r, o = (n || "0 0").split(" ").map(j), s = o[0], a = o[1];
            this.offsetTop = s,
            this.offsetLeft = a,
            this.apply = function() {
    ...
    Ui.extend = function(t) {
        ...
        return ((e.prototype = Object.create(this.prototype)).constructor = e).options = Ai(this.options, t),
        e.super = this,
                    ...
                    Object.defineProperty(n, r, {
                        ...
                        get: function() {
                            var t = n._computeds
                              , e = n.$props
                              , i = n.$el;
                            return l(t, r) || (t[r] = (o.get || o).call(n, e, i)),
                            t[r]
                        },
                        set: function(t) {
                            var e = n._computeds;
    ...
    Ki.prototype._initObserver = function() {
        var t, n = this, e = this.$options, r = e.attrs, i = e.props, o = e.el;
        !this._observer && i && !1 !== r && (r = k(r) ? r : Object.keys(i),
    ...
    Zi.component = function(s, t) {
        ...
        if (s = f(e),
        !t)
            return T(tn[s]) && (tn[s] = Zi.extend(tn[s])),
            tn[s];
        Zi[s] = function(t, i) {
        ...
        Zi._initialized && !i.functional && xi.read(function() {
      ...
      , an = {
        ...
        methods: {
            ...
            _toggleElement: function(t, e, i) {
                var n = this;
                if (e = z(e) ? e : ni.inProgress(t) ? He(t, "uk-animation-leave") : Qe.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t),
                !Jt(t, "before" + (e ? "show" : "hide"), [this]))
                    return ae.reject();
                var o, r = ($(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? hn(this) : (o = this,
                function(t, e) {
                    ni.cancel(t);
                    var i = o.animation
                      , n = o.duration
                      , r = o._toggle;
                    return e ? (r(t, !0),
                    ni.in(t, i[0], n, o.origin)) : ni.out(t, i[1] || i[0], n, o.origin).then(function() {
                        return r(t, !1)
                    })
                }
                ) : this._toggle)(t, e);
            ...
            _toggle: function(t, e) {
                var i;
                t && (e = Boolean(e),
                this.cls ? (i = b(this.cls, " ") || e !== He(t, this.cls)) && Le(t, this.cls, b(this.cls, " ") ? void 0 : e) : (i = e === st(t, "hidden")) && ot(t, "hidden", e ? null : ""),
    ...
    var un = {
        ...
        computed: {
            items: {
                ...
                watch: function(t, e) {
                    ...
                    e || He(t, this.clsOpen) || (i = !1 !== this.active && t[Number(this.active)] || !this.collapsible && t[0]) && this.toggle(i, !1)
                },
                immediate: !0
            }
        },
        events: [{
            ...
            handler: function(t) {
                t.preventDefault(),
                this.toggle(me(Ne(this.targets + " " + this.$props.toggle, this.$el), t.current))
            }
        }],
        methods: {
            toggle: function(t, r) {
                ...
                (this.collapsible || Rt(e, ":not(." + this.clsOpen + ")").length) && e.forEach(function(t) {
                    return o.toggleElement(t, !He(t, o.clsOpen), function(e, i) {
                        Le(e, o.clsOpen, i);
                        var n = Me((e._wrapper ? "> * " : "") + o.content, e);
                        if (!1 !== r && o.hasTransition)
                            return e._wrapper || (e._wrapper = Ie(n, "<div" + (i ? " hidden" : "") + ">")),
                            cn(n, !1),
                            hn(o)(e._wrapper, i).then(function() {
                                ...
                                delete e._wrapper,
                                Te(n),
                                i && (Bi(t = Me(o.$props.toggle, e)) || Oi(t, {
                                    offset: o.offset
                                }))
                            });
                        cn(n, !i)
    ...
    var pn, mn = {
        ...
        events: [{
            ...
            handler: function() {
                ...
                Kt(this.$el, "hide", Xt(document, mt, function(t) {
                    var r = t.target;
                ...
                Kt(this.$el, "hide", Xt(document, "keydown", function(t) {
            ...
            handler: function(t) {
                var e = t.target;
                this.$el === e ? (pn = this.isActive() ? null : pn,
                Jt(this.$el, "updatearia"),
                this.tracker.cancel()) : pn = null === pn && qt(e, this.$el) && this.isToggled() ? this : pn
            }
        }, {
            name: "updatearia",
            self: !0,
        ...
        methods: {
            ...
            position: function() {
                ...
                var t, e = si(this.boundary), i = this.boundaryAlign ? e : si(this.toggle.$el);
                "justify" === this.align ? (t = "y" === this.getAxis() ? "width" : "height",
                Re(this.$el, t, i[t])) : this.$el.offsetWidth > Math.max(e.right - i.left, i.right - e.left) && De(this.$el, this.clsDrop + "-stack"),
    ...
    var vn = {
        ...
        computed: {
            ...
            target: function(t, e) {
                var i = t.target;
                return i && (!0 === i && this.input.parentNode === e && this.input.nextElementSibling || yt(i, e))
            }
        },
        update: function() {
            var t, e, i, n = this.target, r = this.input;
            !n || n[e = Vt(n) ? "value" : "textContent"] !== (i = r.files && r.files[0] ? r.files[0].name : zt(r, "select") && (t = Ne("option", r).filter(function(t) {
                return t.selected
            })[0]) ? t.textContent : r.value) && (n[e] = i)
        },
        events: [{
            name: "change",
            handler: function() {
        ...
        for (var n = [[]], r = 0; r < t.length; r++) {
            ...
            if (jt(o))
                for (var s = kn(o), a = n.length - 1; 0 <= a; a--) {
                    ...
                    var u = void 0
                      , u = h[0].offsetParent === o.offsetParent ? kn(h[0]) : (s = kn(o, !0),
                    kn(h[0], !0));
        ...
        update: [{
            ...
            read: function(t) {
                var e = t.columns
                  , i = t.rows
                  , n = Yt(this.$el);
                if (!n.length || !this.masonry && !this.parallax)
                    return !1;
                var r, o, s, a, h, u = n.some(Qe.inProgress), c = !1, l = e.map(function(t) {
                    return t.reduce(function(t, e) {
                ...
                j((s = r.filter(function(t) {
                    return He(t, o)
                })[0]) ? Re(s, "marginTop") : Re(r[0], "paddingLeft")) * (i.length - 1)), f = Math.max.apply(Math, l) + d;
                ...
                return {
                    padding: p = p && l.reduce(function(t, e, i) {
            ...
            write: function(t) {
                ...
                !1 === n && !r || e.forEach(function(t, i) {
                    return t.forEach(function(t, e) {
                        return Re(t, "transform", n || r ? "translateY(" + ((r && -r[i][e]) + (n ? i % 2 ? n : n / 8 : 0)) + "px)" : "")
                    })
                })
            },
            events: ["scroll", "resize"]
        ...
        update: {
            read: function(t) {
                ...
                if (this.expand) {
                    ...
                    var r, i = "calc(100vh";
                    this.offsetTop && (i += 0 < (r = si(this.$el).top) && r < ci(window) / 2 ? " - " + r + "px" : ""),
                    !0 === this.offsetBottom ? i += " - " + Cn(this.$el.nextElementSibling) + "px" : P(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? i += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (i += " - " + Cn(yt(this.offsetBottom, this.$el)) + "px"),
                    i += (n ? " - " + n + "px" : "") + ")"
                }
                return {
                    minHeight: i,
            ...
            getSvg: function() {
                ...
                return function(i) {
                    ...
                    return Mn[i] = new ae(function(e, t) {
                        i ? w(i, "data:") ? e(decodeURIComponent(i.split(",")[1])) : de(i).then(function(t) {
                            return e(t.response)
                        }, function() {
                    ...
                    return function(t, e) {
                        e && b(t, "<symbol") && (t = function(t, e) {
                            if (!zn[t]) {
                                var i;
                                for (zn[t] = {},
                                Nn.lastIndex = 0; i = Nn.exec(t); )
                                    zn[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>"
                            }
                            return zn[t][e]
                        }(t, e) || t);
    ...
    var Pn = {
      ...
      , Fn = {
        ...
        computed: {
            icon: function(t, e) {
                var i = t.icon;
                return He(e, "uk-search-icon") && Ut(e, ".uk-search-large").length ? "search-large" : Ut(e, ".uk-search-navbar").length ? "search-navbar" : i
            }
        }
    }
      , jn = {
      ...
      , Wn = {
        ...
        connected: function() {
            ...
            this.svg.then(function(t) {
                return 1 !== e.ratio && Re(Me("circle", t), "strokeWidth", 1 / e.ratio)
            }, et)
        }
    }
      , Vn = {};
    var Rn = {
        ...
        update: {
            ...
            write: function(t) {
                var e, i, n, r, o;
                this.dataSrcset && 1 !== window.devicePixelRatio && (!(e = Re(this.$el, "backgroundSize")).match(/^(auto\s?)+$/) && j(e) !== t.bgSize || (t.bgSize = (i = this.dataSrcset,
                n = this.sizes,
                r = wi(Yn(n)),
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return qn(e.$el, Zn(t), t.srcset, t.sizes),
                    Qn[e.cacheKey] = Zn(t),
                    t
                }, et),
                this.observer.disconnect())
    ...
    function Yn(t) {
        ...
        for (Un.lastIndex = 0; e = Un.exec(t); )
            if (!e[1] || window.matchMedia(e[1]).matches) {
                e = w(i = e[2], "calc") ? i.substring(5, i.length - 1).replace(Xn, function(t) {
                    return wi(t)
                }).replace(/ /g, "").match(Gn).reduce(function(t, e) {
                    return t + +e
                }, 0) : i;
                break
            }
    ...
    var ir = {
      ...
      , or = {
        ...
        events: [{
            ...
            handler: function() {
                var o = this;
                li(window) - li(document) && this.overlay && Re(document.body, "overflowY", "scroll"),
                this.stack && Re(this.$el, "zIndex", Re(this.$el, "zIndex") + rr.length),
                De(document.documentElement, this.clsPage),
                this.bgClose && Kt(this.$el, "hide", Xt(document, mt, function(t) {
                    var r = t.target;
                ...
                this.escClose && Kt(this.$el, "hide", Xt(document, "keydown", function(t) {
                    27 === t.keyCode && K(rr) === o && (t.preventDefault(),
                    o.hide())
                }), {
                    self: !0
                })
        ...
        return function(r, o) {
            return new ae(function(i, n) {
                return Kt(r, "show hide", function() {
                    ...
                    r._reject = n,
                    a(r, o);
                    var t = Kt(s, "transitionstart", function() {
                        Kt(s, "transitionend transitioncancel", i, {
                            self: !0
                        }),
                        clearTimeout(e)
                    }, {
    ...
    var ar = {
        install: function(t) {
            ...
            a.alert = function(i, t) {
                return e(function(t) {
                    var e = t.labels;
                    return '<div class="uk-modal-body">' + (D(i) ? i : we(i)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>' + e.ok + "</button> </div>"
                }, t, function(t) {
                    return t.resolve()
                })
            }
            ...
            a.confirm = function(i, t) {
                return e(function(t) {
                    var e = t.labels;
                    return '<form> <div class="uk-modal-body">' + (D(i) ? i : we(i)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">' + e.cancel + '</button> <button class="uk-button uk-button-primary" autofocus>' + e.ok + "</button> </div> </form>"
                }, t, function(t) {
                    return t.reject()
                })
            }
      ...
      , ur = {
        ...
        computed: {
            ...
            dropbar: {
                get: function(t) {
                    var e = t.dropbar;
                    return e ? (e = this._dropbar || yt(e, this.$el) || Me("+ .uk-navbar-dropbar", this.$el)) || (this._dropbar = Me("<div></div>")) : null
                },
                watch: function(t) {
        ...
        events: [{
            ...
            handler: function(t, e) {
                var i = e.$el
                  , n = e.dir;
                Le(this.dropbar, "uk-navbar-dropbar-slide", "slide" === this.dropbarMode || Ut(this.$el).some(function(t) {
                    return "static" !== Re(t, "position")
                })),
                this.clsDrop && De(i, this.clsDrop + "-dropbar"),
                "bottom" === n && this.transitionTo(i.offsetHeight + j(Re(i, "marginTop")) + j(Re(i, "marginBottom")), i)
            }
        }, {
            name: "beforehide",
            filter: function() {
      ...
      , cr = {
        ...
        events: [{
            ...
            handler: function(t) {
                ...
                ((r = i.scrollHeight) <= (o = i.clientHeight) || 0 === n && 0 < e || r - n <= o && e < 0) && t.cancelable && t.preventDefault())
            }
        }, {
            name: "show",
            self: !0,
      ...
      , pr = {
        ...
        methods: {
            scrollTo: function(t) {
                ...
                Jt(this.$el, "beforescroll", [this, t]) && Oi(t, {
                    offset: this.offset
                }).then(function() {
        ...
        update: [{
            ...
            write: function(n) {
                ...
                this.elements.forEach(function(e) {
                    ...
                    !i.show || i.inview || i.queued ? !i.show && i.inview && !i.queued && r.repeat && t(!1) : (i.queued = !0,
                    n.promise = (n.promise || ae.resolve()).then(function() {
                        return new ae(function(t) {
      ...
      , gr = {
        ...
        update: [{
            ...
            write: function(t) {
                ...
                !1 !== e && Jt(this.$el, "active", [e, De(this.elements[e], this.cls)])
            },
            events: ["scroll", "resize"]
        }]
    }
      , vr = {
        ...
        computed: {
            ...
            isActive: {
                ...
                set: function(t) {
                    ...
                    Jt(this.$el, "active")) : t || He(this.selTarget, this.clsInactive) || (Oe(this.selTarget, this.clsActive, this.clsInactive),
                    Jt(this.$el, "inactive"))
                }
            }
        },
        connected: function() {
            this.placeholder = Me("+ .uk-sticky-placeholder", this.$el) || Me('<div class="uk-sticky-placeholder"></div>'),
            this.isFixed = !1,
            this.isActive = !1
        },
        disconnected: function() {
        ...
        update: [{
            read: function(t, e) {
                ...
                this.topOffset = si(this.isFixed ? this.placeholder : this.$el).top,
            ...
            read: function(t) {
                var e = t.scroll;
                return void 0 === e && (e = 0),
                this.width = si(jt(this.widthElement) ? this.widthElement : this.$el).width,
            ...
            write: function(t, e) {
                ...
                var r = t.dir
                  ...
                  , u = t.visible
                  , c = performance.now();
                if (!((t.lastScroll = a) < 0 || a === s || !u || this.disabled || this.showOnUp && "scroll" !== e || ((300 < c - n || r !== o) && (t.initScroll = a,
                t.initTimestamp = c),
                t.lastDir = r,
                this.showOnUp && !this.isFixed && Math.abs(t.initScroll - a) <= 30 && Math.abs(s - a) <= 10)))
                    if (this.inactive || a < this.top || this.showOnUp && (a <= this.top || "down" === r || "up" === r && !this.isFixed && a <= this.bottomOffset)) {
                        if (!this.isFixed)
                            return void (ni.inProgress(this.$el) && a < h && (ni.cancel(this.$el),
                            this.hide()));
                        this.isFixed = !1,
                        this.animation && a > this.topOffset ? (ni.cancel(this.$el),
                        ni.out(this.$el, this.animation).then(function() {
                            return i.hide()
                        }, et)) : this.hide()
                    } else
                        this.isFixed ? this.update() : this.animation ? (ni.cancel(this.$el),
                        this.show(),
                        ni.in(this.$el, this.animation).catch(et)) : this.show()
            },
            events: ["resize", "scroll"]
        }],
        methods: {
    ...
    function wr(t, e) {
        var i = e.$props
          ...
          , o = i[t];
        if (o)
            return D(o) && o.match(/^-?\d/) ? r + wi(o) : si(!0 === o ? n.parentNode : yt(o, n)).bottom
    }
    var br, xr, yr, kr = {
        mixins: [an],
        args: "connect",
        ...
        methods: {
            ...
            show: function(t) {
                ...
                this.children.forEach(function(t, e) {
                    Le(t, i.cls, r === e),
                    ot(i.toggles[e], "aria-expanded", r === e)
                }),
                this.connects.forEach(function(t) {
                    var e = t.children;
                    return i.toggleElement(V(e).filter(function(t, e) {
        ...
        methods: {
            toggle: function(t) {
                var e, i = this;
                Jt(this.target, t || "toggle", [this]) && (this.queued ? (e = this.target.filter(this.isToggled),
                this.toggleElement(e, !1).then(function() {
                    return i.toggleElement(i.target.filter(function(t) {
                        return !b(e, t)
                    }), !0)
    ...
    qi.use(function(r) {
        ut && pe(function() {
            ...
            Xt(document, "animationstart", function(t) {
                var e = t.target;
                (Re(e, "animationName") || "").match(/^uk-.*(left|right)/) && (n++,
            ...
            Xt(document, mt, function(t) {
                ...
                i = Kt(document, vt + " " + xt, function(t) {
                    ...
                    (a && r && 100 < Math.abs(s.x - r) || o && 100 < Math.abs(s.y - o)) && setTimeout(function() {
                        ...
                        i = r,
                        n = o,
                        Math.abs(t - i) >= Math.abs(e - n) ? 0 < t - i ? "Left" : "Right" : 0 < e - n ? "Up" : "Down"))
                    })
                }))
            }, {
                passive: !0
    ...
    xr = (br = qi).connect,
    yr = br.disconnect,
    ut && window.MutationObserver && xi.read(function() {
        ...
        methods: {
            animate: function(t) {
                ...
                var s = ci(this.target)
                  , a = (r = r.concat(Yt(this.target).filter(function(t) {
                    return !b(r, t)
                }))).map(function(t, e) {
                    return !!(t.parentNode && e in o) && (o[e] ? jt(t) ? Mr(t) : {
                        opacity: 0
                    } : {
                        opacity: jt(t) ? 1 : 0
                    })
                  ...
                  , o = a.map(function(t, e) {
                    ...
                    return i && (t ? "opacity"in t || (i.opacity % 1 ? t.opacity = 1 : delete i.opacity) : delete i.opacity),
                    i
                });
                return De(this.target, Er),
                ...
                }).concat(e !== s && Qe.start(this.target, {
                    height: s
        ...
        computed: {
            toggles: {
                ...
                watch: function() {
                    var e, i = this;
                    this.updateState(),
                    !1 !== this.selActive && (e = Ne(this.selActive, this.$el),
        ...
        methods: {
            ...
            setState: function(u, t) {
                ...
                function e() {
                    ...
                    var n, r, o, s = u.sort, a = s[0], h = s[1];
                    a && (r = a,
                    o = h,
                    Y(n = G([], l).sort(function(t, e) {
                        return ht(t, r).localeCompare(ht(e, r), void 0, {
                            numeric: !0
                        }) * ("asc" === o || -1)
    ...
    var jr = {
        mixins: [{
            ...
            methods: {
                startAutoplay: function() {
                    ...
                    this.stopAutoplay(),
                    this.interval = setInterval(function() {
                        return (!t.draggable || !Me(":focus", t.$el)) && (!t.pauseOnHover || !zt(t.$el, ":hover")) && !t.stack.length && t.show("next")
                ...
                move: function(t) {
                    ...
                    if (this.unbindMove) {
                        ...
                        if (!(0 == i || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                            ...
                            this.percent = o / a;
                            var h, u = n[r], c = n[s], l = this.index !== s, d = r === s;
            ...
            update: {
                write: function() {
                    ...
                    Le(Ne(this.selNavItem, this.$el).concat(this.nav), "uk-hidden", !this.maxIndex),
                    this.updateNav()
                },
                events: ["resize"]
            },
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        ...
                        Le(t, "uk-invisible", i.finite && ("previous" === e && 0 === n || "next" === e && n >= i.maxIndex))
                    })
                }
            }
        }],
        ...
        methods: {
                ...
                !this.dragging && this.length) {
                    ...
                    !e && 1 < n.length)
                        ...
                        if (u !== l) {
                            ...
                            this.prevIndex = h,
                            this.index = c,
                            u && !Jt(u, "beforeitemhide", [this]) || !Jt(l, "beforeitemshow", [this, u]))
                                return this.index = this.prevIndex,
                                void o();
                            var d = this._show(u, l, e).then(function() {
                                return u && Jt(u, "itemhidden", [i]),
                                Jt(l, "itemshown", [i]),
                                new ae(function(t) {
                                    xi.write(function() {
                                        n.shift(),
            ...
            _getTransitioner: function(t, e, i, n) {
                ...
                new this.Transitioner(B(t) ? this.slides[t] : t,B(e) ? this.slides[e] : e,i * (lt ? -1 : 1),n)
            }
        }
    };
    function Wr(t) {
        ...
        events: [{
            ...
            handler: function(t, r) {
                var o = this
                  ...
                  , s = r.alt;
                void 0 === s && (s = "");
                var a, h, i, u = r.poster, c = r.attrs;
                void 0 === c && (c = {}),
                ...
                "image" === e || n.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i) ? fe(n, c.srcset, c.size).then(function(t) {
                    var e = t.width
                      , i = t.height;
                    ...
                    return o.setError(r)
                }) : "video" === e || n.match(/\.(mp4|webm|ogv)($|\?)/i) ? (Xt(i = qr("video", G({
                    src: n,
                    poster: u,
                    controls: "",
                    playsinline: "",
                ...
                Xt(i, "error", function() {
                    return o.setError(r)
                })) : "iframe" === e || n.match(/\.(html)($|\?)/i) ? this.setItem(r, qr("iframe", G({
                    src: n,
                    frameborder: "0",
                    allowfullscreen: "",
                    class: "uk-lightbox-iframe"
                }, c))) : (a = n.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) ? this.setItem(r, qr("iframe", G({
                    src: "https://www.youtube" + (a[1] || "") + ".com/embed/" + a[2] + (a[3] ? "?" + a[3] : ""),
                    width: 1920,
                    height: 1080
                }, h, c))) : (a = n.match(/\/\/.*?vimeo\.[a-z]+\/(\d+)[&?]?(.*)?/)) && de("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(n), {
                    responseType: "json",
                    withCredentials: !1
                }).then(function(t) {
                    var e = t.response
    ...
    var Ur, Yr = {
        ...
        methods: {
            show: function(t) {
                var i, e = this, n = Q(this.toggles.map(Xr), "source");
                return M(t) && (i = Xr(t).source,
                t = y(n, function(t) {
                    var e = t.source;
                    return i === e
                })),
    ...
    var Gr = {
        ...
        connected: function() {
            var t, e = this, i = j(Re(this.$el, this.marginProp));
      ...
      , Jr = {
        ...
        computed: {
            props: function(m, g) {
                ...
                return Kr.reduce(function(t, e) {
                    if (H(m[e]))
                        return t;
                    var i, n, r = e.match(/color/i), o = r || "opacity" === e, s = m[e].slice(0);
                    o && Re(g, e, ""),
                    ...
                    n = Re(g, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1],
                    i = v.covers ? (u = Math.min.apply(Math, s),
            ...
            covers: function(t, e) {
                return n = (i = e).style.backgroundSize,
        ...
        update: {
            read: function(t) {
                ...
                t.active && (t.image || !this.covers || !this.bgProps.length || (e = Re(this.$el, "backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/, "$1")) && ((i = new Image).src = e,
                (t.image = i).naturalWidth || (i.onload = function() {
                    return l.$update()
                }
                )),
                (n = t.image) && n.naturalWidth && (h = {
                ...
                this.bgProps.forEach(function(t) {
                    var e, i = l.props[t], n = i.diff, r = i.bgPos, o = i.steps, s = "bgy" === t ? "height" : "width", a = c[s] - h[s];
                    a < n ? h[s] = c[s] + n - a : n < a && ((e = h[s] / wi(r, s, l.$el)) && (l.props[t].steps = o.map(function(t) {
                        return t - (a - n) / e
                    }))),
                    c = rt.cover(u, h)
                }),
    ...
    var Qr = {
        ...
        update: {
            read: function(t, e) {
                ...
                t.active) {
                    var n, r, o = i;
                    return n = Hi(this.target) / (this.viewport || 1),
                    r = this.easing,
                    {
    ...
    function eo(t, e, i) {
        var n, r = ro(t, e);
        return i ? r - (n = t,
        si(e).width / 2 - si(n).width / 2) : Math.min(r, io(e))
    }
    function io(t) {
            ...
            Transitioner: function(r, n, o, t) {
                ...
                return {
                    ...
                    translate: function(t) {
                        ...
                        Re(a, "transform", Or(tt(e - e * t - u, -no(a), si(a).width) * (lt ? -1 : 1), "px")),
                    ...
                    percent: function() {
                        return Math.abs((Re(a, "transform").split(",")[4] * (lt ? -1 : 1) + i) / (u - i))
                    },
                    getDistance: function() {
                        return Math.abs(u - i)
                    },
        ...
        computed: {
            ...
            sets: function(t) {
                ...
                return !O(e = e && this.slides.reduce(function(t, e, i) {
                    var n, r = si(e).width;
                    return a < u + r && (!o.center && i > o.maxIndex && (i = o.maxIndex),
                    b(t, i) || (n = o.slides[i + 1],
                    o.center && n && r < h - si(n).width / 2 ? h -= r : (h = s,
                    t.push(i),
        ...
        events: {
            beforeitemshow: function(t) {
                ...
                if (!this.dragging && 1 < e) {
                    ...
                    this.duration = Wr(this.avgWidth / this.velocity) * (si(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth),
                    this.reorder()
            },
            itemshow: function() {
            ...
            reorder: function() {
                ...
                if (this.finite)
                    ...
                    if (this.slides.forEach(function(t, e) {
                        return Re(t, "order", 0 < i.dir && e < n ? 1 : i.dir < 0 && e >= i.index ? -1 : "")
                    }),
                    this.center)
      ...
      , ho = {
        ...
        events: [{
            ...
            handler: function(t) {
                ...
                Qe.start(this.$el, this.getCss(uo(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(et)
            }
        }, {
            ...
            handler: function(t) {
                var e = t.type
                  ...
                  , r = i.dir;
                Qe.cancel(this.$el),
                Re(this.$el, this.getCss(co(e, r, n)))
            }
        }]
    };
    function uo(t) {
    ...
    var lo, fo, po = G({}, Br, {
        ...
        update: {
            read: function() {
                ...
                return this.minHeight && (i = Math.max(this.minHeight, i)),
        ...
        methods: {
            init: function(t) {
                ...
                !r || n || 0 < i || Vt(e) || qt(e, "." + this.clsNoDrag) || this.handle && !qt(e, this.handle) || (t.preventDefault(),
                this.touched = [this],
                this.placeholder = r,
                this.origin = G({
                    target: e,
            ...
            start: function(t) {
                ...
                i = this.placeholder,
                ot(n = be(e, i.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g, "$1div$2")), "style", ot(n, "style") + ";margin:0!important"),
                Re(n, G({
                    boxSizing: "border-box",
                    width: i.offsetWidth,
                    height: i.offsetHeight,
                    overflow: "hidden"
                }, Re(i, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))),
            ...
            move: function(t) {
                ...
                this.drag ? (clearInterval(lo),
                e = this.getSortable(this.placeholder),
                this === e ? this.origin.index !== me(this.placeholder) && Jt(this.$el, "moved", [this, this.placeholder]) : (Jt(e.$el, "added", [e, this.placeholder]),
                Jt(this.$el, "removed", [this, this.placeholder])),
                Jt(this.$el, "stop", [this, this.placeholder]),
                $e(this.drag),
                this.drag = null,
                i = this.touched.map(function(t) {
            ...
            insert: function(i, n) {
                ...
                function t() {
                    var t, e;
                    n ? (!qt(i, r.target) || (e = n,
                    (t = i).parentNode === e.parentNode && me(t) > me(e)) ? xe : ye)(n, i) : be(r.target, i)
                }
        ...
        methods: {
            ...
            _show: function() {
                ...
                Xt(this.tooltip, "toggled", function() {
                    ...
                    e.origin = "y" === e.getAxis() ? vi(e.dir) + "-" + e.align : e.align + "-" + vi(e.dir))
                }),
                    ...
                    var r = function(t, e) {
                      ...
                      , o = function(t) {
                        ...
                        de(n.url, {
                            ...
                            n.complete(t),
                            r.length ? o(r.shift()) : n.completeAll(t)
                        }, function(t) {
                            return n.error(t)
                        })
                    };
